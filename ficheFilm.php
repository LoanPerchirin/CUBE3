...
<section>
    ...
    <div class="compartimentPhotoInfo">
        <img id="photofilm" src="images/ProfilBlanc.png" alt="photoCasting">

        <div class="infoCasting">
            <h2 class="marginEnMoins">TitrePHP</h2>

            <p class="marginEnMoins">PHPdate ; 16+ PHPheure</p>

            <h3 class="marginEnMoins">Avis</h3>

            <h4 class="marginEnMoins">PHP/5/</h4>

            <h3 class="marginEnMoins">Créateurs</h3>

            <p class="marginEnMoins">PHP.createur</p>

            <h3 class="marginEnMoins">Acteurs</h3>

            <p class="marginEnMoins">(code PHP)</p>

            <button style="margin-top:10px;">PHP</button>
    ...
    <div id="test6">
        <div class="alignement">
            <h3 class="marginEnMoins">Catégories:</h3><p>PHP</p>
        </div>

        <div class="alignement">
            <h3 class="marginEnMoins">Awards:</h3><p>PHP</p>
        </div>  

        <div class="alignement">
            <h3 class="marginEnMoins">Soundtracks:</h3><p>PHP</p>    
        </div>

        <div class="alignement">
            <h3 class="marginEnMoins">Box office:</h3><p>PHP</p>
        </div>
    </div>

    <h2 class="text-align-center">Résumé</h2>
...
<!-- DÉBUT FOOTER -->
<footer>
    <div class="sous-footer" id="footer1">
        <div id="logoReseaux">
